...
public class SmashCSS : MonoBehaviour
{
    ...
    public GameObject charCellPerfab;
    ...
    {
        GameObject charCell = Instantiate(charCellPerfab, transform);
    ...
    public void ShowCharacterInSlot(int player, Character character)
    {
        ...
        if (artwork != null)
        {
            ...
            slotArtwork.GetComponent<RectTransform>().sizeDelta = slotArtworkSize * character.zoom;
        }
